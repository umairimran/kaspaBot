...
const TwitterBotManager: React.FC = () => {
  ...
  const fetchStatus = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/twitter/status`);
  ...
  const fetchQueue = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/twitter/queue`);
      const data = await response.json();
      if (data.success) {
  ...
  const fetchInteractions = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/twitter/interactions?limit=5`);
      const data = await response.json();
      if (data.success) {
  ...
  const startBot = async () => {
    setLoading(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/twitter/start`, { method: 'POST' });
      const data = await response.json();
      if (data.success) {
        await fetchStatus();
        setError(null);
  ...
  const stopBot = async () => {
    setLoading(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/twitter/stop`, { method: 'POST' });
      const data = await response.json();
      if (data.success) {
        await fetchStatus();
        setError(null);
  ...
  const clearQueue = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/twitter/queue/clear`, { method: 'POST' });
      const data = await response.json();
      if (data.success) {
        await fetchQueue();
        setError(null);
  ...
  const clearInteractions = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/twitter/interactions/clear`, { method: 'POST' });
      const data = await response.json();
      if (data.success) {
